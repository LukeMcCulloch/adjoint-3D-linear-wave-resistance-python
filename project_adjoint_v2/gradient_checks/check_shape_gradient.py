...
#import rankine_panel.objectives #import Objectives          # wherever you put compute_dJ_dsigma_JnegFx
from rankine_panel.gradient_validators import Validate_dj_dsigma
...
if __name__ == '''__main__''':
    ...
    Validate_shape_gradient.check_shape_grad_beam_scale(
        ...
        Objectives=Validate_shape_gradient,
